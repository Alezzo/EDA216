...
public class BookingPane extends BasicPane {
	...
	class DateSelectionListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
            ...
            fields[MOVIE_NAME].setText(performance.getmovieName());
	...
	class ActionHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			displayMessage("Working, throwing minions at the problem until it has been resolved!");
			...
			if (db.bookPerformance(movieName, Date.valueOf(date), CurrentUser.instance().getCurrentUserId())) {
				...
				System.out.println("Booked, the minions has succeeded with the task");
			} else {
